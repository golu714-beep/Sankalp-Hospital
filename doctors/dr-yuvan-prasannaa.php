...
<head>
  ...
  <title>Dr. Yuvan Prasannaa | Best Pediatrics Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Yuvan Prasannaa, MBBS, MD - Pediatrics at Sankalp Hospital in Ambikapur. Consultant Pediatrician providing general pediatric consultations and child growth tracking.">
    ...
    <div class="row align-items-center g-4 g-lg-5 mt-2">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          ...
          <p class="dp-hero-degrees">MBBS, MD - Pediatrics</p>
          <p class="dp-hero-bio">Consultant Pediatrician providing general pediatric consultations and child growth tracking.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <p class="dp-profile-text">Dr. Yuvan Prasannaa is a Consultant Pediatrician at Sankalp Hospital. He offers routine child healthcare, growth and development tracking, childhood immunizations, and guidance on nutritional needs for infants and young children in the region.</p>
          ...
          <div class="dp-expertise-grid">
            ...
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Immunization &amp; Vaccination</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Childhood Infections Care</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Pediatric Nutrition Counseling</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Asthma &amp; Allergy Management</span>
          </div>
