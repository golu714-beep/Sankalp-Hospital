...
<head>
  ...
  <title>Dr. Vijaya Singh | Best Obstetrics & Gynaecology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Vijaya Singh, MBBS, DGO - Gynecology at Sankalp Hospital in Ambikapur. Dedicated Gynecologist offering general maternity checkups, out-patient screenings, and normal deliveries.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Vijaya Singh</span>
      </div>
    </div>
    ...
    <div class="row align-items-center g-4 g-lg-5 mt-2">
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/vijaya-singh.jpg" alt="Dr. Vijaya Singh" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          ...
          <h1 class="dp-hero-name">Dr. Vijaya Singh</h1>
          <p class="dp-hero-degrees">MBBS, DGO - Gynecology</p>
          <p class="dp-hero-bio">Dedicated Gynecologist offering general maternity checkups, out-patient screenings, and normal deliveries.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Vijaya Singh</h2>
          <p class="dp-profile-text">Dr. Vijaya Singh is a dedicated Gynecologist at Sankalp Hospital offering comprehensive outpatient care, routine prenatal screenings, and normal deliveries. She is known for her approachable nature and focus on health education for young mothers.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Antenatal &amp; Postnatal Care</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Routine Gynaec Screenings</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Normal Delivery Management</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Family Planning Guidance</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Menopause Counselling</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Vijaya Singh. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="obstetrics">
              <input type="hidden" id="book-doc" value="Dr. Vijaya Singh">
              <div class="mb-3">
