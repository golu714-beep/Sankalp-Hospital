...
<head>
  ...
  <title>Dr. Nagaraj G Naik | Best Anesthesiology Specialist in Ambikapur | Sankalp Hospital</title>
  <meta name="description" content="Consult Dr. Nagaraj G Naik, DA, DNB - Anaesthesiology at Sankalp Hospital in Ambikapur. Consultant Anaesthetist and Intensivist coordinating surgical sedation and painless labor protocols.">
  ...
  <div class="container">
    ...
    <div class="dp-breadcrumb">
      <div class="dp-breadcrumb-list">
        ...
        <span class="sep"><i class="fas fa-chevron-right"></i></span>
        <span class="current">Dr. Nagaraj G Naik</span>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="dp-photo-wrapper">
          <div class="dp-photo-card">
            <img src="/images/nagaraj-naik.jpg" alt="Dr. Nagaraj G Naik" onerror="this.src='/images/doc1.png'">
      ...
      <div class="col-lg-8 col-md-7">
        <div class="dp-hero-content">
          <span class="dp-specialty-tag">
            <i class="fas fa-stethoscope"></i> Anesthesiology
          </span>
          <h1 class="dp-hero-name">Dr. Nagaraj G Naik</h1>
          <p class="dp-hero-degrees">DA, DNB - Anaesthesiology</p>
          <p class="dp-hero-bio">Consultant Anaesthetist and Intensivist coordinating surgical sedation and painless labor protocols.</p>
    ...
    <div class="row g-4 g-lg-5">
      ...
      <div class="col-lg-7">
        <div class="dp-profile-card">
          ...
          <h2 class="dp-section-title">About Dr. Nagaraj G Naik</h2>
          <p class="dp-profile-text">Dr. Nagaraj G Naik is a Consultant Anaesthetist and Intensivist at Sankalp Hospital with 15+ years of clinical experience. He coordinates surgical sedation, critical care management in the ICU, and manages advanced labor analgesia (painless labor) protocols.</p>
          ...
          <div class="dp-expertise-grid">
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> General &amp; Regional Anesthesia</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Painless Labor (Epidural)</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> ICU Life Support Coordination</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Pre-Anesthetic Health Profiling</span>
            <span class="dp-exp-pill"><i class="fas fa-check-circle"></i> Post-Operative Pain Relief</span>
          </div>
      ...
      <div class="col-lg-5">
        <div class="dp-sticky-sidebar">
          ...
          <div class="dp-book-card">
            ...
            <p class="dp-book-sub">Schedule a consultation with Dr. Nagaraj G Naik. Our coordinator will reach out to confirm.</p>
            <form id="detailed-booking-form" class="appointment-form">
              <input type="hidden" id="book-dept" value="anesthesiology">
              <input type="hidden" id="book-doc" value="Dr. Nagaraj G Naik">
              <div class="mb-3">
